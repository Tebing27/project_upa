<footer class="bg-slate-900 border-t border-slate-800 pt-16 pb-8 text-white relative z-20">
    <div class="max-w-[85rem] mx-auto w-full px-6 lg:px-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            <div class="lg:col-span-4 flex flex-col gap-6">
                <img src="{{ asset('assets/logo.webp') }}" alt="Logo LSP UPNVJ"
                    class="h-20 w-auto object-contain self-start bg-white p-2 rounded-xl shadow-lg">
                ...
                <div class="flex flex-col gap-4 mt-2 text-sm text-slate-300">
                    <div class="flex items-start gap-4">
                        <div
                            class="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center shrink-0 text-[#ea580c]">
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="flex flex-col gap-4 text-sm text-slate-300">
                    <li><a href="{{ route('home') }}"
                            class="hover:text-white hover:translate-x-1 transition-all flex items-center gap-2 group"><svg
                                class="w-4 h-4 text-slate-600 group-hover:text-[#ea580c] transition-colors"
                    ...
                    <li><a href="{{ route('cek-sertifikat') }}"
                            class="hover:text-white hover:translate-x-1 transition-all flex items-center gap-2 group"><svg
                                class="w-4 h-4 text-slate-600 group-hover:text-[#ea580c] transition-colors"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="https://www.instagram.com/lspupnvj/" target="_blank" aria-label="Instagram"
                        class="w-10 h-10 rounded-full bg-slate-800 hover:bg-[#ea580c] flex items-center justify-center transition-all hover:scale-110 text-white shadow-md">
        ...
        <div
            class="border-t border-slate-800 pt-8 mt-4 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-400">
