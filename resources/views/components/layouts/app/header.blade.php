            ...
            <div x-show="sidebarOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex w-64 flex-1 flex-col bg-white pb-4 pt-5 dark:bg-zinc-900">
                ...
                <nav class="mt-5 h-full space-y-1 px-2">
                    @if ($isAdmin)
                        ...
                        <a href="{{ route('admin.verifikasi') }}" wire:navigate @class(['flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors', 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' => request()->routeIs('admin.verifikasi*'), 'text-zinc-600 hover:bg-emerald-50/50 hover:text-emerald-600 dark:text-zinc-400 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300' => !request()->routeIs('admin.verifikasi*')])>
                        ...
                        <a href="{{ route('admin.jadwal') }}" wire:navigate @class(['flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors', 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' => request()->routeIs('admin.jadwal'), 'text-zinc-600 hover:bg-emerald-50/50 hover:text-emerald-600 dark:text-zinc-400 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300' => !request()->routeIs('admin.jadwal')])>
                        ...
                        <a href="{{ route('admin.hasil-uji') }}" wire:navigate @class(['flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors', 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' => request()->routeIs('admin.hasil-uji'), 'text-zinc-600 hover:bg-emerald-50/50 hover:text-emerald-600 dark:text-zinc-400 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300' => !request()->routeIs('admin.hasil-uji')])>
                    ...
                    @else
                        ...
                        <a href="{{ route('dashboard.status') }}" wire:navigate @class(['flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors', 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' => request()->routeIs('dashboard.status'), 'text-zinc-600 hover:bg-emerald-50/50 hover:text-emerald-600 dark:text-zinc-400 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300' => !request()->routeIs('dashboard.status')])>
                            <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                            {{ __('Status Pendaftaran') }}
                        </a>
                        <a href="{{ route('dashboard.certificates') }}" wire:navigate @class(['flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors', 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' => request()->routeIs('dashboard.certificates'), 'text-zinc-600 hover:bg-emerald-50/50 hover:text-emerald-600 dark:text-zinc-400 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-300' => !request()->routeIs('dashboard.certificates')])>
