                ...
                @foreach ($pendingCompetencyRegistrations as $registration)
                    <div class="flex flex-col gap-4 px-6 py-5 md:px-8 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div class="flex flex-col gap-2 sm:flex-row">
                            ...
                            @else
                                <button disabled
                                    class="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-100 px-4 py-2.5 text-sm font-semibold text-slate-400">
                                    Surat keterangan belum tersedia
                                </button>
                            @endif

                            <button disabled
                                class="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-400">
                                Sertifikat copy menunggu upload admin
                            </button>
                        </div>
                    </div>
                @endforeach
