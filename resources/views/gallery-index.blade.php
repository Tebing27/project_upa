...
<body class="antialiased bg-slate-50 text-slate-800 flex flex-col min-h-screen" x-data="{
    modalOpen: false,
    modalImage: '',
    modalTitle: '',
    modalDesc: '',
    ...
    <main class="flex-grow pt-32 pb-24 px-6 lg:px-16 container mx-auto">
        <div class="max-w-[85rem] mx-auto w-full">
            ...
            <div class="text-center mb-16">
                <h1 class="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-4 tracking-tight">
                    Dokumentasi <span class="text-[#ea580c]">Kegiatan</span></h1>
                <p class="text-gray-600 max-w-2xl mx-auto mt-4 text-lg">Momen-momen penting dari perjalanan kegiatan
                    sertifikasi di institusi kami.</p>
            </div>
    ...
    <div x-show="modalOpen"
        ...
        <div class="relative max-w-5xl w-full mx-auto flex flex-col justify-center items-center pointer-events-none"
            ...
            <button @click="modalOpen = false"
                class="absolute -top-12 right-0 text-white hover:text-gray-300 pointer-events-auto transition rounded-full p-2 bg-black/40 hover:bg-black/80">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <template x-if="modalType === 'photo'">
                <img :src="modalImage" :alt="modalTitle"
                    class="max-h-[75vh] w-auto max-w-full rounded-lg shadow-2xl bg-gray-900 mx-auto pointer-events-auto border border-gray-700">
            </template>
            <template x-if="modalType === 'video'">
                <video :src="modalImage"
                    class="max-h-[75vh] w-auto max-w-full rounded-lg shadow-2xl bg-gray-900 mx-auto pointer-events-auto border border-gray-700"
            ...
            <!-- Modal Text -->
            <div
                class="bg-black/60 backdrop-blur-md rounded-b-lg w-full max-w-[var(--tw-max-w)] max-h-min border border-t-0 border-gray-800 p-6 pointer-events-auto mt-4 text-center">
